...
urlpatterns = [
   ...
   path('add-customer-invoice/<int:booking_id>/', views.add_customer_invoice_view, name='add_customer_invoice'),
   ...
   path('add-partner-invoice/<int:booking_id>/', views.add_partner_invoice_view, name='add_partner_invoice'),
